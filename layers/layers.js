...
var format_Violacionessectoresmarzo2022_1 = new ol.format.GeoJSON();
var features_Violacionessectoresmarzo2022_1 = format_Violacionessectoresmarzo2022_1.readFeatures(json_Violacionessectoresmarzo2022_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Violacionessectoresmarzo2022_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Violacionessectoresmarzo2022_1.addFeatures(features_Violacionessectoresmarzo2022_1);
var lyr_Violacionessectoresmarzo2022_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Violacionessectoresmarzo2022_1, 
                style: style_Violacionessectoresmarzo2022_1,
                interactive: true,
    title: 'Violaciones sectores  marzo 2022<br />\
    <img src="styles/legend/Violacionessectoresmarzo2022_1_0.png" /> 0 - 0<br />\
    <img src="styles/legend/Violacionessectoresmarzo2022_1_1.png" /> 0 - 1<br />\
    <img src="styles/legend/Violacionessectoresmarzo2022_1_2.png" /> 1 - 1<br />\
    <img src="styles/legend/Violacionessectoresmarzo2022_1_3.png" /> 1 - 2<br />\
    <img src="styles/legend/Violacionessectoresmarzo2022_1_4.png" /> 2 - 8<br />'
        });
...
lyr_CartoPositron_0.setVisible(true);lyr_Violacionessectoresmarzo2022_1.setVisible(true);lyr_alcaldias_cdmx_2.setVisible(true);lyr_09ent_3.setVisible(true);lyr_colonias_cdmx_4.setVisible(true);lyr_sectores_5.setVisible(true);
var layersList = [lyr_CartoPositron_0,lyr_Violacionessectoresmarzo2022_1,lyr_alcaldias_cdmx_2,lyr_09ent_3,lyr_colonias_cdmx_4,lyr_sectores_5];
lyr_Violacionessectoresmarzo2022_1.set('fieldAliases', {'gid': 'gid', 'id': 'id', 'delegcn': 'delegcn', 'zona': 'zona', 'cve_zon': 'cve_zon', 'cnsc_rg': 'cnsc_rg', 'cnsc_sc': 'cnsc_sc', 'nmbr_sc': 'nmbr_sc', 'ct': 'ct', 'x': 'x', 'y': 'y', 'id_lcld': 'id_lcld', 'NUMPOINTS': 'NUMPOINTS', });
...
lyr_Violacionessectoresmarzo2022_1.set('fieldImages', {'gid': 'Range', 'id': 'TextEdit', 'delegcn': 'TextEdit', 'zona': 'TextEdit', 'cve_zon': 'TextEdit', 'cnsc_rg': 'TextEdit', 'cnsc_sc': 'TextEdit', 'nmbr_sc': 'TextEdit', 'ct': 'TextEdit', 'x': 'TextEdit', 'y': 'TextEdit', 'id_lcld': 'Range', 'NUMPOINTS': 'TextEdit', });
...
lyr_Violacionessectoresmarzo2022_1.set('fieldLabels', {'gid': 'no label', 'id': 'no label', 'delegcn': 'inline label', 'zona': 'inline label', 'cve_zon': 'no label', 'cnsc_rg': 'no label', 'cnsc_sc': 'no label', 'nmbr_sc': 'no label', 'ct': 'no label', 'x': 'no label', 'y': 'no label', 'id_lcld': 'no label', 'NUMPOINTS': 'inline label', });
lyr_alcaldias_cdmx_2.set('fieldLabels', {'gid': 'no label', 'cvegeo': 'no label', 'cve_ent': 'no label', 'cve_mun': 'no label', 'nomgeo': 'inline label', 'geo_alcald': 'inline label', 'nombre_upp': 'no label', 'zona': 'no label', });
